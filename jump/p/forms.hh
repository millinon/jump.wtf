					...
					<h2><!--<span class="label label-primary">-->Submit a Link or File<!--</span>--></h2>
						<form id="new_url_form" action="s" method="post"  enctype="multipart/form-data" onsubmit="subbutton()">
							...
							<span class="input-group-addon" style="width:6em; text-align:left">
								...
								<input type="url" class="form-control" name="new_url" id="new_url" placeholder="http://www.example.com/" maxlength=128 autofocus required autocomplete="off">
							</div>
							<div class="input-group" style="width:80%">
								<span class="input-group-addon" style="width:6em; text-align:left">
										<input type="radio" name="sub_type" value="file" id="sel_file" autocomplete="off">
										File:
								</span>
									<input type="hidden" name="MAX_FILE_SIZE" value="8388608">
									<input type="file" class="form-control" name="file" id="new_file" disabled required autocomplete="off">
							</div>
							<div class="input-group" style="width:80%">
							...
							<div class="input-group" style="width: 50%">
								<span class="input-group-addon">
								<input type="checkbox" name="expires" id="expires" onclick="t1()">
									Expire after clicks:
							</span>
							<input type="number" class="form-control" name="clicks" id="clicks" min="1" max="1000" step="1" value="" style="width:6em" disabled>
						</div>
						<input type="hidden" name="action" id="action" value="new">
						<button id="newsub" type="submit" class="btn btn-primary">
								<span id="newsub_glyph" class="glyphicon glyphicon-link" aria-hidden="true"></span>
								Submit
						</button>
					</form>
			</div>
						...
						<form id="del_form" action="s" method="post">
							<div class="input-group" style="width:80%">
								<span class="input-group-addon">ID:</span>
									<input type="text" class="form-control" name="del_url" id="del_url" pattern="(https?://jump.wtf/)?[A-Za-z0-9]{2,6}" placeholder="AbcD0" required autocomplete="off" style="width:8em">
							</div>
							<div class="input-group" style="width:80%">
								<span class="input-group-addon">
									Password:
